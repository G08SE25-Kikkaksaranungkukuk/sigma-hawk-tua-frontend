      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen p-6">
        <div className="w-full max-w-md space-y-8 text-center bounce-in">
          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            <div>
              <h1 className="text-4xl font-bold text-white drop-shadow-lg">TravelMatch</h1>
              <p className="text-xl text-orange-300 mt-2 drop-shadow">Find your perfect travel companion</p>
            </div>
          </div>
          ...
          <div className="bg-gray-900/40 backdrop-blur-sm rounded-2xl p-4 mt-6 border border-orange-500/20">
            <p className="text-sm text-orange-300">
              🌍 Join <span className="font-semibold text-orange-400">50,000+</span> travelers worldwide
            </p>
