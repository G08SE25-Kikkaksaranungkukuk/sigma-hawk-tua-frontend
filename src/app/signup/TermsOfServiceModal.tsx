...
const TermsOfServiceModal: React.FC<TermsOfServiceModalProps & { onScrolledToBottom: () => void; scrolledToBottom: boolean }> = ({ isOpen, onClose, onScrolledToBottom, scrolledToBottom }) => {
